...
def getArtistsByGenre(library, genre):
    returnlist = []
    for key in library:
        if key == genre:
...
if __name__ == "__main__": # This line is needed for the auto-grader. DO NOT CHANGE IT!
    ...
    print("Searching Library 1 for all blues artists:")
    print("Result:", getArtistsByGenre(library_1, "blues"))
    print()

    print("Searching Library 1 for all hiphop artists:")
    print("Result:", getArtistsByGenre(library_1, "hiphop"))
    print()
